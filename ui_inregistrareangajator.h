...
public:
    ...
    void setupUi(QDialog *InregistrareAngajator)
    {
        ...
        InregistrareAngajator->resize(435, 461);
        InregistrareAngajator->setStyleSheet(QString::fromUtf8("background-color: rgb(222, 242, 241);"));
        lineEdit_4 = new QLineEdit(InregistrareAngajator);
        lineEdit_4->setObjectName(QString::fromUtf8("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(110, 160, 221, 26));
...
"font-size: 18px;"));
        ...
        lineEdit_3 = new QLineEdit(InregistrareAngajator);
        lineEdit_3->setObjectName(QString::fromUtf8("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(110, 60, 221, 26));
        lineEdit_3->setStyleSheet(QString::fromUtf8("background-color: white;\n"
"border-radius: 10px;"));
        pushButton_5 = new QPushButton(InregistrareAngajator);
        pushButton_5->setObjectName(QString::fromUtf8("pushButton_5"));
        pushButton_5->setGeometry(QRect(160, 320, 120, 40));
        QFont font1;
        font1.setBold(false);
...
"font: Times New Roman;"));
        ...
        label->setGeometry(QRect(150, 380, 171, 61));
...
"font-size: 18px;"));
        ...
        lineEdit_5 = new QLineEdit(InregistrareAngajator);
        lineEdit_5->setObjectName(QString::fromUtf8("lineEdit_5"));
        lineEdit_5->setGeometry(QRect(110, 260, 221, 26));
...
"border-radius: 10px;"));
    ...
    void retranslateUi(QDialog *InregistrareAngajator)
    {
        ...
        pushButton_5->setText(QCoreApplication::translate("InregistrareAngajator", "\303\216nregistrare", nullptr));
        label->setText(QString());
        label_companie->setText(QCoreApplication::translate("InregistrareAngajator", "Nume Companie", nullptr));
        label_parola->setText(QCoreApplication::translate("InregistrareAngajator", "Parola", nullptr));
    } // retranslateUi
